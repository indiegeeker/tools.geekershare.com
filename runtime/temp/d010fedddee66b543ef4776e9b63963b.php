<?php /*a:1:{s:72:"/www/wwwroot/tools.geekershare.com/application/admin/view/web/index.html";i:1656658083;}*/ ?>
<!DOCTYPE html>
<html>
...
<form class="layui-form " action="" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <div>
                <button class="layui-btn" onclick="window.open('https://tools.geekershare.com/<?php echo htmlentities($key); ?>/')" type="button">打开页面</button>
            </div>
